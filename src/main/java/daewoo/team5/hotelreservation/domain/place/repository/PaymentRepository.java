...
public interface PaymentRepository extends JpaRepository<PaymentEntity, Long> {
    ...
    Page<PaymentEntity> findAllByReservation_Guest_Id(Long guestId, Pageable pageable);
    ...
    // 예약 ID로 모든 결제 조회
    List<PaymentEntity> findByReservation_ReservationId(Long reservationId);

    // 예약 ID로 가장 최근 결제 1건만 조회
    Optional<PaymentEntity> findTop1ByReservation_ReservationIdOrderByTransactionDateDesc(Long reservationId);
